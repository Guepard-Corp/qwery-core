...
import { loadConversationTitle } from '~/lib/loaders/route-meta-loaders';

export async function clientLoader(args: Route.ClientLoaderArgs) {
  const conversationTitle = await loadConversationTitle(
    args.request,
    args.params.slug,
  );
...
export const meta = ({ data }: Route.MetaArgs) => [
  { title: pageTitle(data?.conversationTitle ?? 'Chat') },
];
