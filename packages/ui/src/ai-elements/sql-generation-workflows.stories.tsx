      ...
      <div className="space-y-2 p-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-muted-foreground text-xs">
            {displayedRows.toLocaleString()} of {totalRows.toLocaleString()}{' '}
            rows in {duration}
          </span>
        </div>
        ...
        <Conversation>
          <ConversationContent>
            ...
            <Message from="assistant">
              <MessageContent>
                <MessageResponse>
                  I'll generate a SQL query to retrieve all users from the users
                  table.
                </MessageResponse>
              </MessageContent>
            </Message>
        ...
        <Conversation>
          <ConversationContent>
            ...
            <Message from="assistant">
              <MessageContent>
                <MessageResponse>
                  I need to analyze the requirements and generate an appropriate
                  SQL query.
                </MessageResponse>
              </MessageContent>
            </Message>
        ...
        <Conversation>
          <ConversationContent>
            ...
            <Message from="assistant">
              <MessageContent>
                <MessageResponse>
                  I'll generate a SQL query to find products with price greater
                  than 100.
                </MessageResponse>
              </MessageContent>
              <MessageActions>
            ...
            <Message from="assistant">
              <MessageContent>
                <MessageResponse>
                  I see the error - the column is named 'unit_price', not
                  'price'. Let me fix the query.
                </MessageResponse>
              </MessageContent>
            </Message>
...
ORDER BY category, year DESC, month DESC;`;
          ...
          if (messageIndex < fullResponseText.length) {
            ...
            setStreamedMessage(
              fullResponseText.slice(
                0,
                Math.min(messageIndex, fullResponseText.length),
              ),
            );
          }
    ...
    return (
      <div className="mx-auto flex h-screen w-full max-w-4xl flex-col p-4">
        <PromptInputProvider>
          <Conversation className="flex-1">
            <ConversationContent>
              <Message from="user">
                <MessageContent>
                  <MessageResponse>
                    Generate a SQL query for monthly sales report with YoY
                    comparison
                  </MessageResponse>
                </MessageContent>
              </Message>
              {isThinking && (
                <>
                  <Message from="assistant">
                    <MessageContent>
                      <MessageResponse>
                        I'll generate a comprehensive SQL query for your monthly
                        sales report with year-over-year comparison.
                      </MessageResponse>
                    </MessageContent>
                  </Message>
                  <Loader />
        ...
        <Conversation>
          <ConversationContent>
            ...
            <Message from="assistant">
              <MessageContent>
                <MessageResponse>
                  I'll help you identify churned customers. Let me break this
                  down into steps.
                </MessageResponse>
              </MessageContent>
            </Message>
                  ...
                  output={{
                    headers: [
                      ...
                      },
                      {
                        ...
                        displayName: 'days_since_last_order',
                        originalType: 'integer',
                      },
                    ],
                    rows: [
        ...
        <Conversation>
          <ConversationContent>
            ...
            <Message from="assistant">
              <MessageContent>
                <MessageResponse>
                  I'll update the query to use boolean for status and include
        ...
        <Conversation>
          <ConversationContent>
            <Message from="user">
              <MessageContent>
                <MessageResponse>
                  Find all orders from the last 30 days with their customer
                  names and total amounts
                </MessageResponse>
              </MessageContent>
              <MessageActions>
                <MessageAction tooltip="Copy" label="Copy">
            ...
            <Message from="assistant">
              <MessageContent>
                <MessageResponse>
                  I'll generate a SQL query to find recent orders with customer
                  information.
                </MessageResponse>
              </MessageContent>
            </Message>
...
WHERE o.order_date >= DATE_SUB(NOW(), INTERVAL 30 DAY);`,
            ...
            <Message from="assistant">
              <MessageContent>
                <MessageResponse>
                  I see the issue - PostgreSQL uses different date functions.
                  Let me use CURRENT_DATE with INTERVAL instead. (v2)
                </MessageResponse>
              </MessageContent>
            </Message>
            <Tool defaultOpen={true}>
...
WHERE o.order_date >= CURRENT_DATE - INTERVAL '30 days';`,
            ...
            <Message from="assistant">
              <MessageContent>
                <MessageResponse>
                  The column is named 'amount', not 'total_amount'. Let me fix
                  that. (v3)
                </MessageResponse>
              </MessageContent>
            </Message>
...
WHERE o.order_date >= CURRENT_DATE - INTERVAL '30 days';`,
            ...
            <Message from="assistant">
              <MessageContent>
                <MessageResponse>
                  The date column is 'created_at'. Let me update the query with
                  the correct column name. (v4)
                </MessageResponse>
              </MessageContent>
            </Message>
            <Tool defaultOpen={true}>
...
ORDER BY o.created_at DESC;`,
            ...
            <Message from="assistant">
              <MessageContent>
                <MessageResponse>
                  Perfect! The query is now working correctly. I found 5 orders
                  from the last 30 days with customer names and amounts, sorted
