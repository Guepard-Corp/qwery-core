        ...
        <div
          className={cn(
            ...
            variant === 'floating' || variant === 'inset'
              ...
              : 'group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left]:border-r group-data-[side=left]:dark:border-border group-data-[side=right]:border-l group-data-[side=right]:dark:border-border',
            className,
          )}
          {...props}
        >
