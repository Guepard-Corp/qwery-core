...
export const TablePrivilegesOptionalZodSchema = z.optional(TablePrivilegesZodSchema);

export type TablePrivileges = z.infer<typeof TablePrivilegesZodSchema>;
export type TablePrivilegesArray = z.infer<typeof TablePrivilegesArrayZodSchema>;
export type TablePrivilegesOptional = z.infer<typeof TablePrivilegesOptionalZodSchema>;
