...
export const MaterializedViewArrayZodSchema = z.array(MaterializedViewZodSchema);
export const MaterializedViewOptionalZodSchema = z.optional(MaterializedViewZodSchema);
